...
- Clone this repo to your local machine using `https://github.com/divyanshi26/john-lemon-s-haunted-jaunt-3d-beginner.git`

### Run

- Go to **John Lemon's Haunted Jaunt**->**Builds**->**Build 1.0** and open **John Lemon's Haunted Jaunt.exe** (on Windows).
- Choose the recommended setting and hit **Play!**
- Help John Lemon escape the Haunted House by navigating it through the house, hiding from the static Gargoyles and the moving Ghosts!
